    ...
    <div id="yudingBox">
        ...
        <div class="tableBox">
            <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="truck.vehicle.number" label="运输车次"></el-table-column>
                <el-table-column prop="submituser.name" label="提交人"></el-table-column>
                <el-table-column prop="confirmuser.name" label="确认人"></el-table-column>
