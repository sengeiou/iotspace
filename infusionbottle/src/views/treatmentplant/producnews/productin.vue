    ...
    <div id="yudingBox">
        ...
        <div class="tableBox">
            <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="cmaterialcategory.name" label="类别"></el-table-column>
        ...
        <el-dialog
          ...
          <div class="dialogMain">
            <el-form ref="addForm" :model="addForm" label-width="100px">
                ...
                <el-form-item label="来源">
                    <el-select v-model="addForm.source" placeholder="请选择破碎料来源">
  ...
  export default {
    ...
    methods: {
      ...
      getSelectList(){
        ...
        //入库来源
        this.$ajax.get("/recovery/cmaterialin/sourceList",{
          params:{
            treatmentplantid: sessionStorage.getItem('belongId'),
          }
        }).then(function(response){
      ...
      getData(){
        ...
        this.$ajax.get("/recovery/cmaterialin/selectVByPage",{
            params:{
              page: this.page,
              rows: this.pageSize,
              treatmentplantid: sessionStorage.getItem('belongId'),
        ...
        // this.$ajax.get("/recovery/cmaterialin/sumWeightGroupByCategory",{
        //     params:{
        //       treatmentplantid: sessionStorage.getItem('belongId'),
      ...
      addSaveForm(index){
        ...
        if(this.addOrUpTit == "添加破碎料"){
          this.$ajax.post("/recovery/cmaterialin/insert",params).then(function(response){
            if(response.data.status == 260){
          ...
          this.$ajax.put("/recovery/cmaterialin/update",params).then(function(response){
            if(response.data.status == 260){
              that.centerDialogVisible = false;
      ...
      delAll(){
        ...
        this.$confirm('此操作将永久删除选中的破碎料, 是否继续?', '提示', {
          ...
          var that = this;
          this.$ajax.delete("/recovery/cmaterialin/deletes",{data:this.multipleSelection}).then(function(response){
            if(response.data.status == 260){
      ...
      handleDelete(index, row) {
        this.$confirm('此操作将删除该破碎料, 是否继续?', '提示', {
          ...
          var that = this;
          this.$ajax.delete("/recovery/cmaterialin/delete",{params:{
            id: row
          }}).then(function(response){
            if(response.data.status == 260){
              that.$message.success("删除成功")
